<template>
  <nav-sidebar top="66px" class="side-nav" :collapsible="true" :collapseText="$t('collapse')" contentClass="admin-main">
    ...
    <nav-sidebar-item :title="$tc('worklist.worklist', 1)" :route="{ name: 'statuses' }">
      <template slot="icon">
        <clipboard-text-icon />
      </template>
    </nav-sidebar-item>
    <nav-sidebar-item :title="$tc('admin.user', 1)" :route="{ name: 'users' }">
      <template slot="icon">
        <account-icon />
      </template>
    </nav-sidebar-item>
    <nav-sidebar-item :title="$tc('conference.conference', 1)" :route="{ name: 'conference-settings' }">
      <template slot="icon">
        <message-video-icon />
      </template>
    </nav-sidebar-item>
